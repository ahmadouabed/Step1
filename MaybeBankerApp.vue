    ...
    <main class="app" v-if="currentAccount">
      ...
      <div class="operation operation--transfer">
        ...
        <form class="form form--transfer" @submit.prevent="transferMoney">
          ...
          <input type="number" v-model.number="transferAmount" class="form__input form__input--amount" />
      ...
      <div class="operation operation--loan">
        ...
        <form class="form form--loan" @submit.prevent="requestLoan">
          <input type="number" v-model.number="loanAmount" class="form__input form__input--loan-amount" />
  ...
  methods: {
    handleLogin() {
      const account = this.accounts.find(
        (acc) => acc.owner.toLowerCase().split(' ').map(name => name[0]).join('') === this.loginUser
      );
